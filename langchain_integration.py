...
class AutonomousAgentConfig(BaseModel):
    ...
    agent_type: str  # memory_curator, intelligence_monitor, credential_rotator, auto_builder
    enabled: bool
...
class RAGSystem:
    ...
    def __init__(self):
        self.firestore_project = os.getenv("FIRESTORE_PROJECT", "infinity-x-one-systems")
