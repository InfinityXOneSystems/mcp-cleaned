...
class Synthesis:
    ...
    synthesis_id: str
    hypothesis_id: str
    improvement_type: str  # prompt_change, weight_adjustment, threshold_change, architectural
...
class ImprovementLoop:
    ...
    async def _validate(
        ...
        return [h for h in hypotheses if h.confidence >= 0.7 or h.hypothesis_id not in challenged_ids]
