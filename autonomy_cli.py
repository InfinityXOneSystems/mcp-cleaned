...
from autonomy_stack.models import AgentRole, MemoryEntry
...
def check_security() -> None:
    ...
    print(f"OpenAI API configured: {'✓' if security.get_secret('openai_api_key') else '✗'}")
...
Examples:
  ...
  python autonomy_cli.py security-check
    ...
    exec_parser.add_argument("agent", choices=["visionary", "strategist", "builder", "critic"])
    ...
    # Export memory
    export_parser = subparsers.add_parser("export-memory", help="Export memory collection")
