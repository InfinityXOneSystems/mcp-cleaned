...
def main():
    try:
        router = init_agents()
        ctx = AgentContext(session_id="smoke1", task_id="smoke1", governance_level="LOW")
        payload = {"context": ctx, "data": {"seed": {"sources": [{"url": "https://example.com", "title": "Example", "content": "Example content for smoke test."}]}}}
