...
from autonomy_stack.agent_factory import AgentFactory, VisionaryAgent, StrategistAgent
...
from autonomy_stack.task_queue import TaskQueue
...
class TestSecurityManager:
    ...
    def test_api_key_validation(self):
        ...
        result = security.validate_api_key("wrong_key")
