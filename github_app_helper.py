...
class GitHubApp:
    ...
    def _load_config(self):
        ...
        config_path = (
            Path.home()
            / "AppData/Local/InfinityXOne/CredentialManager/.github-app-config.json"
        )
    ...
    def _load_private_key(self):
        ...
        key_path = (
            Path.home()
            / "AppData/Local/InfinityXOne/CredentialManager/github-app-private-key.pem"
        )
        if key_path.exists():
    ...
    def generate_jwt(self):
        ...
        now = int(time.time())
        payload = {"iat": now, "exp": now + (10 * 60), "iss": self.app_id}  # 10 minutes
    ...
    def make_api_request(
        self, method, endpoint, installation_type="infinityxone", **kwargs
    ):
    ...
    def list_repos(self, installation_type="infinityxone"):
        ...
        return self.make_api_request(
            "GET", "/installation/repositories", installation_type
        )
    ...
    def create_issue(
        ...
        body=None,
        labels=None,
        installation_type="infinityxone",
    ):
        ...
        return self.make_api_request(
            "POST", f"/repos/{owner}/{repo}/issues", installation_type, json=data
        )

    def get_file_content(
        self, owner, repo, path, ref="main", installation_type="infinityxone"
    ):
    ...
    def list_organization_repos(self):
        ...
        return self.make_api_request(
            "GET", "/installation/repositories", "infinityxone"
        )
...
def test_github_app():
    ...
    try:
        ...
        app.get_installation_token("infinityxone")
        ...
        print(f"\n📊 Rate Limit Status:")
        print(
            f"  • Remaining: {rate_limit['rate']['remaining']}/{rate_limit['rate']['limit']}"
        )
