...
try:
    ...
    print(
        "⚠️  Google API libraries not installed. Run: pip install google-auth google-auth-oauthlib google-auth-httplib2 google-api-python-client"
    )
...
def full_sync():
    ...
    try:
        ...
        if "GOOGLE_APPLICATION_CREDENTIALS" in str(e):
            ...
            print(
                "   3. Set environment variable: $env:GOOGLE_APPLICATION_CREDENTIALS='path/to/key.json'"
            )
