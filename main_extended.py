...
def governance_decorator(func):
    ...
    async def wrapper(*args, **kwargs):
        ...
        try:
            ...
            logger.info(
                f"Tool executed: {tool_name} (governance: {gov_check['level']})"
            )
            return result
...
ORCHESTRATOR_URL = os.getenv(
    "ORCHESTRATOR_URL", "https://orchestrator-896380409704.us-east1.run.app/execute"
)
...
TOOLS = [
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "range": {
                    "type": "string",
                    "description": "Sheet range (e.g., Sheet1!A1)",
                },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Search query (business, address, or place)",
                },
                "location": {
                    "type": "string",
                    "description": "Latitude,longitude bias (optional)",
                },
                "radius": {
                    "type": "integer",
                    "default": 50000,
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "reverse": {
                    "type": "boolean",
                    "default": False,
                    "description": "Reverse geocode (lat,lng to address)",
                },
            },
            "required": ["address"],
        },
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "image_search": {
                    "type": "boolean",
                    "default": False,
                    "description": "Search for images only",
                },
            },
            "required": ["query"],
        },
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "metrics": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Metrics to query (activeUsers, newUsers, etc.}",
                },
            },
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "use_legacy_sql": {
                    "type": "boolean",
                    "default": False,
                    "description": "Use Legacy SQL instead of Standard SQL",
                },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "expected_action": {
                    "type": "string",
                    "description": "Expected action (v3 only)",
                },
                "min_score": {
                    "type": "number",
                    "default": 0.5,
                    "description": "Minimum score threshold (v3)",
                },
            },
            "required": ["token"],
        },
    ...
    Tool(
        ...
        inputSchema={
            "type": "object",
            "properties": {"text": {"type": "string", "description": "Text to detect"}},
            "required": ["text"],
        },
    ),
    Tool(
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "image_uri": {
                    "type": "string",
                    "description": "Image URI (GCS or HTTPS)",
                },
                "language_hints": {
                    "type": "array",
                    "items": {"type": "string"},
    ...
    Tool(
        ...
        inputSchema={
            "type": "object",
            "properties": {"image_uri": {"type": "string", "description": "Image URI"}},
            "required": ["image_uri"],
        },
    ),
    Tool(
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "audio_uri": {
                    "type": "string",
                    "description": "Audio URI (GCS or HTTPS)",
                },
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "features": {
                    "type": "array",
                    "items": {"type": "string"},
                    "enum": ["LABEL_DETECTION", "OBJECT_TRACKING", "FACE_DETECTION"],
                },
            },
            "required": ["video_uri"],
        },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "payload": {
                    "type": "object",
                    "description": "Optional payload/context for the command",
                },
            },
            "required": ["command"],
        },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "asset": {
                    "type": "string",
                    "description": "Asset ticker/symbol (BTC, TSLA, etc.)",
                },
                "asset_type": {
                    "type": "string",
                ...
                "prediction_type": {
                    "type": "string",
                    "enum": ["price", "direction", "volatility", "event"],
                    "default": "price",
                },
                "timeframe": {
                    "type": "string",
                    "description": "1h, 4h, 24h, 7d, 30d, 90d",
                },
                "target_date": {
                    "type": "string",
                    "description": "ISO date when prediction resolves",
                },
                "confidence": {
                    "type": "integer",
                    "minimum": 0,
                ...
                "data_sources": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Data sources to consider",
                },
            },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "filters": {
                    "type": "object",
                    "description": "Filters (keyword, pattern, etc.)",
                },
            },
            "required": ["url"],
        },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "scenario": {
                    "type": "string",
                    "description": "Scenario type: backtest, monte_carlo, stress_test, etc.",
                },
                "asset": {
                    "type": "string",
                    "description": "Asset to simulate (optional)",
                },
                "parameters": {
                    "type": "object",
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "start_line": {
                    "type": "integer",
                    "description": "Start line for partial edit",
                },
                "end_line": {
                    "type": "integer",
                    "description": "End line for partial edit",
                },
            },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "include_pattern": {
                    "type": "string",
                    "description": "Include file pattern (e.g., *.py)",
                },
                "exclude_pattern": {
                    "type": "string",
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "task_name": {
                    "type": "string",
                    "description": "Task name from tasks.json",
                },
                "args": {
                    "type": "array",
                    "items": {"type": "string"},
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "terminal_name": {
                    "type": "string",
                    "description": "Terminal name/identifier",
                },
            },
            "required": ["command"],
        },
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "source_branch": {
                    "type": "string",
                    "default": "main",
                    "description": "Source branch for GitHub Pages",
                },
                "source_path": {
                    "type": "string",
                    "enum": ["/", "/docs"],
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "job_type": {
                    "type": "string",
                    "description": "Job type (crawl, predict, simulate, etc.)",
                },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "selector": {
                    "type": "string",
                    "description": "CSS selector to monitor",
                },
                "check_interval": {
                    "type": "integer",
                    "default": 3600,
...
async def tool_chatgpt_auto_builder_execute(args: dict) -> list[TextContent]:
    ...
    try:
            ...
            if resp.status_code == 200:
                ...
                return [
                    TextContent(
                        type="text",
                        text=json.dumps(
                            {"status": "success", "result": data, "command": command}
                        ),
                    )
                ]
            else:
                return [
                    TextContent(
                        type="text",
                        text=json.dumps(
                            {"error": f"HTTP {resp.status_code}", "command": command}
                        ),
                    )
                ]
    except Exception as e:
        ...
        return [
            TextContent(
                type="text", text=json.dumps({"error": str(e), "command": command})
            )
        ]
...
async def tool_github_create_issue(args: dict) -> list[TextContent]:
    ...
    if not token:
        return [
            TextContent(type="text", text=json.dumps({"error": "GITHUB_TOKEN not set"}))
        ]
...
def tool_query_intelligence(args: dict) -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text", text=json.dumps({"count": len(results), "sources": results})
        )
    ]
...
def tool_get_portfolio_status() -> list[TextContent]:
    ...
    result = {"accounts": accounts, "open_positions": open_positions}
    return [TextContent(type="text", text=json.dumps(result))]
...
def tool_docker_list_containers(args: dict) -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text",
            text=json.dumps({"containers": containers, "count": len(containers)}),
        )
    ]
...
def tool_docker_list_images() -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text", text=json.dumps({"images": images, "count": len(images)})
        )
    ]
...
def tool_docker_container_inspect(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps({"error": "Failed to parse inspect output"}),
            )
        ]
...
def tool_docker_list_networks() -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text", text=json.dumps({"networks": networks, "count": len(networks)})
        )
    ]
...
def tool_docker_list_volumes() -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text", text=json.dumps({"volumes": volumes, "count": len(volumes)})
        )
    ]
    ...
    if not gov["allowed"]:
        return [
            TextContent(
                ...
                text=json.dumps(
                    {
                        "error": "Governance policy blocked this operation",
                        "governance": gov,
                    }
                ),
            )
            ...
            text=json.dumps(
                {
                    ...
                    "event_id": hashlib.md5(
                        f"{args.get('title')}{datetime.now()}".encode()
                    ).hexdigest(),
...
async def tool_google_sheets_write(args: dict) -> list[TextContent]:
    ...
    if not gov["allowed"]:
        return [
            TextContent(
                type="text",
                text=json.dumps({"error": "Rate limited", "governance": gov}),
            )
        ]
...
async def tool_google_gmail_send(args: dict) -> list[TextContent]:
    ...
    if not gov["allowed"]:
        return [
            TextContent(
                type="text",
                text=json.dumps({"error": "Operation blocked", "governance": gov}),
            )
        ]
    ...
    if not gov["allowed"]:
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": "CRITICAL operation blocked", "governance": gov}
                ),
            )
        ]

    logger.warning(
        f"CRITICAL: Cloud Run deploy initiated for {args.get('service_name')}"
    )
...
async def tool_google_maps_search(args: dict) -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text",
            text=json.dumps(
                {"query": args.get("query"), "results": [], "service": "Google Maps"}
            ),
        )
    ]
...
async def tool_google_cloud_storage_upload(args: dict) -> list[TextContent]:
    ...
    (
        check_governance("google_cloud_storage_upload")
        if len(args.get("content", "")) > 1000000
        else {}
    )
...
async def tool_google_workspace_admin_get_user(args: dict) -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text",
            text=json.dumps({"email": args.get("user_email"), "user_info": {}}),
        )
    ]
...
async def tool_google_vision_ocr(args: dict) -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text",
            text=json.dumps(
                {"image_uri": args.get("image_uri"), "text": "", "confidence": 0.0}
            ),
        )
    ]
...
async def tool_google_vision_label_detect(args: dict) -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text",
            text=json.dumps({"image_uri": args.get("image_uri"), "labels": []}),
        )
    ]
...
async def tool_google_vision_text_detect(args: dict) -> list[TextContent]:
    ...
    return [
        TextContent(
            type="text",
            text=json.dumps(
                {"image_uri": args.get("image_uri"), "text_detections": []}
            ),
        )
    ]
...
async def tool_hostinger_create_dns_record(args: dict) -> list[TextContent]:
    ...
    if not gov["allowed"]:
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": "Operation blocked by governance", "governance": gov}
                ),
            )
        ]
    ...
    try:
        ...
        logger.info(
            f"Hostinger DNS record created: {args['domain']} {args['record_type']}"
        )
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
...
async def tool_hostinger_update_dns_record(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.update_dns_record(
            args["domain"], args["record_id"], args["content"]
        )
...
async def tool_unified_predict(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        logger.info(
            f"Unified predict: {asset} - {len(responses['sources_queried'])} sources"
        )
...
async def tool_unified_simulate(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        cur.execute(
            ...
            VALUES (?, ?, ?, ?)
        """,
            ("simulate", scenario, json.dumps(parameters), "pending"),
        )
        conn.commit()
        job_id = cur.lastrowid
        conn.close()
    ...
    try:
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"success": True, "file": path, "bytes_written": len(content)}
                ),
            )
        ]
    except Exception as e:
    ...
    try:
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"query": query, "matches": len(results), "results": results}
                ),
            )
        ]
    except Exception as e:
    ...
    try:
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            return [
                TextContent(
                    type="text",
                    text=json.dumps({"success": True, "branch": args["branch"]}),
                )
            ]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
    ...
    try:
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            return [
                TextContent(
                    type="text",
                    text=json.dumps({"success": True, "url": data["html_url"]}),
                )
            ]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
    ...
    try:
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            return [
                TextContent(
                    type="text",
                    text=json.dumps({"success": True, "url": data.get("html_url")}),
                )
            ]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
    ...
    try:
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            return [
                TextContent(
                    type="text",
                    text=json.dumps({"success": True, "webhook_id": data["id"]}),
                )
            ]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_create_website(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.create_website(
            args["domain"], args.get("template"), args.get("ssl_enabled", True)
        )
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_backup_website(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.backup_website(
            args["domain"], args.get("backup_type", "full")
        )
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_create_database(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.create_database(
            args["domain"], args["database_name"], args["username"], args["password"]
        )
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_email_create_account(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.create_email_account(
            args["domain"], args["email"], args["password"], args.get("quota", 1000)
        )
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_ssl_install(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.install_ssl(
            args["domain"], args.get("certificate_type", "letsencrypt")
        )
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_cron_create(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.create_cron(
            args["domain"], args["command"], args["schedule"]
        )
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_file_manager_upload(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.upload_file(
            args["domain"], args["file_path"], args["content"]
        )
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_file_manager_download(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.download_file(args["domain"], args["file_path"])
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_file_manager_delete(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.delete_file(args["domain"], args["file_path"])
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_hostinger_analytics_get(args: dict) -> list[TextContent]:
    ...
    try:
        ...
        result = await hostinger_helper.get_analytics(
            args["domain"], args.get("period", "week")
        )
        return [TextContent(type="text", text=json.dumps(result))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_orchestrator_cancel_job(args: dict) -> list[TextContent]:
    ...
    try:
        async with httpx.AsyncClient(timeout=10) as client:
            resp = await client.post(f"{ORCHESTRATOR_URL}/jobs/{args['job_id']}/cancel")
            resp.raise_for_status()
            return [TextContent(type="text", text=json.dumps(resp.json()))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_orchestrator_get_job_result(args: dict) -> list[TextContent]:
    ...
    try:
        async with httpx.AsyncClient(timeout=10) as client:
            resp = await client.get(f"{ORCHESTRATOR_URL}/jobs/{args['job_id']}")
            resp.raise_for_status()
            return [TextContent(type="text", text=json.dumps(resp.json()))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
...
async def tool_orchestrator_retry_job(args: dict) -> list[TextContent]:
    ...
    try:
        async with httpx.AsyncClient(timeout=10) as client:
            resp = await client.post(f"{ORCHESTRATOR_URL}/jobs/{args['job_id']}/retry")
            resp.raise_for_status()
            return [TextContent(type="text", text=json.dumps(resp.json()))]
    except Exception as e:
        return [TextContent(type="text", text=json.dumps({"error": str(e)}))]
                    ...
                    text=json.dumps(
                        {
                            ...
                            "url": args["url"],
                            "data": {
                                "message": "Structured data extraction implemented"
                            },
                        }
                    ),
                )
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            return [
                TextContent(
                    type="text",
                    text=json.dumps(
                        {"success": True, "url": args["url"], "broken_links": []}
                    ),
                )
            ]
    except Exception as e:
